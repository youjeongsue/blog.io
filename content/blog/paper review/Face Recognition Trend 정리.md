...
3.	키워드: CNN with SGD, harmonic embeddings, harmonic <span style="color:red">Triplet loss</span>
...
3.	키워드: large scale face recognition, <span style="color:red">Additive Angular Margin Loss</span>
![](../image/ArcFace1.png)
![](../image/ArcFace2.png)
![](../image/ArcFace3.png)
...
3.	키워드: <span style="color:red">A-Softmax loss</span>
...
3.	키워드: <span style="color:red">Large Margin Cosine Loss(LMCL)</span>
![](../image/CosFace1.png)
![](../image/CosFace2.png)
...
3.	키워드: <span style="color:red">Re-Identification, AM-Softmax loss</span>, OSNet
...
1. 키워드: <span style="color:red">DREAM block</span>
...
3.	키워드: <span style="color:red">Anti-spoofing</span> for face-recognition
